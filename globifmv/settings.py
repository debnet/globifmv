...
class Base(Configuration):
    ...
    # URL router
    ROOT_URLCONF = 'globifmv.urls'
    # WSGI entrypoint
    WSGI_APPLICATION = 'globifmv.wsgi.application'
    ...
    LOCALE_PATHS = (
        ...
        os.path.join(BASE_DIR, 'fmv/locale'),
    )
    ...
    DEFAULT_FROM_EMAIL = values.Value('Globtopus <globtopus@gmail.fr>')
...
class Prod(Base):
    ...
    # Database
    DATABASES = values.DatabaseURLValue('postgres://user:password@localhost:5432/database?application_name=globifmv')
