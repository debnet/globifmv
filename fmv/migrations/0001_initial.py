    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scene', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='next', to='fmv.Scene', verbose_name='scène précédente')),
            ],
            options={
                'verbose_name': 'scène',
        ...
        migrations.AddField(
            model_name='condition',
            name='scene',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conditions', to='fmv.Scene', verbose_name='scène'),
        ),
        migrations.AddField(
            model_name='action',
            name='item',
